...
<body class="nav-md">
    ...
    <div class="container body">
        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
				...
				<div id="content1">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12" style="height:3000px;width:1000px">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h2>Applications <small>App Information</small></h2>
         ...
         String query1="select * from app_details ";
        ...
        %>
                    <tbody>
                                            <tr>
                                                <th scope="row"><%=rs1.getString("app_id")%></th>
                                                <td><%=rs1.getString("app_name")%></td>
                                                <td><%=rs1.getString("app_desc")%></td>
                                                <td><%=rs1.getString("device")%></td>
                                                <td><%=rs1.getString("tester_name")%></td>
                                                <td><%=rs1.getString("priority")%></td>
                                                <td><%=rs1.getString("app_status")%></td>
