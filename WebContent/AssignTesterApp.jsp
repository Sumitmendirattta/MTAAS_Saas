...
<body class="nav-md">
    ...
    <div class="container body">
        ...
        <div class="main_container">
         ...
         String query1="select DISTINCT(t.username) from tester_details t where t.app_assigned IS NULL OR t.app_assigned LIKE '%Uploaded%'";
         String query2="select DISTINCT(a.app_name) from app_details a where a.tester_name IS NULL OR a.app_status LIKE '%Uploaded%' ";
                        ...
                        <div id="assign">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" novalidate method="post" action="UpdateAssignTester.jsp">
                           
                            <span class="section">Assign Testers to Applications</span>
                            
                                    <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Testers</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" required="required" id="testers" name="testers">
