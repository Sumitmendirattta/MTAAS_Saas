...
<body class="nav-md">
    ...
    <div class="container body">
        ...
        <div class="main_container">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-table"></i> Actions<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li><a href="javascript:assignT()">Show Testers</a>
                                        </li>
            ...
            <div class="right_col" role="main">
				...
				<div id="content1">
                 ...
                 <div class="col-md-6 col-sm-6 col-xs-12" style="height:3000px;width:1000px">
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Developers <small>Developer Information</small></h2>
         ...
         String query1="select d.dev_id,d.email_id,a.app_id,a.app_name,a.priority from dev_details d ,app_details a where d.username=a.developer_name";
